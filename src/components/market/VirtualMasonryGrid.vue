...
const columns = computed(() => {
  ...
  props.items.forEach((item, index) => {
    ...
    const itemData = {
      ...
      originalIndex: index,
      height: itemHeight,
      offsetY: columnHeights.value[shortestColumnIndex],
      columnIndex: shortestColumnIndex
    }
    
    cols[shortestColumnIndex].items.push(itemData)
    columnHeights.value[shortestColumnIndex] += itemHeight + props.gap
    cols[shortestColumnIndex].height = columnHeights.value[shortestColumnIndex]
  })
