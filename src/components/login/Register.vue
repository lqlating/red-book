<template>
    <div class="register-container">
        ...
        <div class="register-form">
            ...
            <div class="input-group">
                <label>个人简介</label>
                <textarea v-model="formData.introduction" placeholder="请输入个人简介"></textarea>
            </div>
...
const handleRegister = async () => {
    if (!formData.username || !formData.account || !formData.email || !formData.password || !formData.confirmPassword || !formData.gender) {
